/*******
Problem: Storing computer datas in struct
Description:
Computer contains: keyboard mouse, 1..2 monitors, 1..4 graphics cards, 1..4 HDD, 1 CPU
All computers have: name, brand, model, serial#
CPU: # of cores (1É6 each has serial #), speed, & serial number
Graphics card: brand, model, serial #
HDD: capacity, interface, serial #
Monitors: serial #, size, resolution
1) Create appropriate structures
2) short-hand initialize 4+ computers
3) then ask user to search by either computer name, number, brand or model (use menu)
4) display the complete records of matching computers
